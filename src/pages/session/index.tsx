...
export default function Session() {
  return (
    <div className={`w-full h-screen mx-auto flex flex-col justify-center items-center bg-own-topvaq-bg-gray text-zinc-100 font-pt-mono`}>
      <Header />

      <Image src={`/logotopvaq.svg`} width={300} height={300} alt="" className={`mx-auto pb-16`} priority />
      ...
      <form action={`/session/in`} method="POST" className={`w-full flex-col justify-center items-center`}>
        <span className={`w-full mx-auto flex justify-center items-center gap-3`}>
        ...
        <span className={`w-full mx-auto flex justify-center items-center gap-3 mt-4`}>
