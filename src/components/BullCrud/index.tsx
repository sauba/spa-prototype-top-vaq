...
import { Item } from '../types'; // Ensure correct path
...
// export const BullCrud: React.FC<BullCrudProps> = ({ data, setData, dataEdit, setDataEdit, isOpen, onClose }) => {
//   const [name, setName] = useState(dataEdit.name || "");
//   const [nomeFantasia, setNomeFantasia] = useState(dataEdit.nomeFantasia || "");
//   const [idade, setIdade] = useState(dataEdit.idade || "");
//   const [peso, setPeso] = useState(dataEdit.peso || "")
...
// export const BullCrud2 = ({ data, setData, dataEdit, setDataEdit, isOpen, onClose }) => {
//   const [name, setName] = useState(dataEdit.name || "")
//   const [nomeFantasia, setNomeFantasia] = useState(dataEdit.nomeFantasia || "")
//   const [idade, setIdade] = useState(dataEdit.idade || "")
//   const [peso, setPeso] = useState(dataEdit.peso || "")
